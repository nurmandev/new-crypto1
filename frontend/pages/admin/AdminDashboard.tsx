          ...
          <div className="flex-1">
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-[20px] font-medium text-black">Platform Profit Overview</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-[20px] font-medium text-black">Recent transactions</h2>
              ...
              {/* System Status */}
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <h2 className="text-[20px] font-medium text-black mb-4">System Status</h2>
                <div className="space-y-2">
                  {systemStatus.map((status, index) => (
                    <SystemStatusItem key={index} label={status.label} value={status.value} />
                  ))}
                </div>
              </div>
            </div>
