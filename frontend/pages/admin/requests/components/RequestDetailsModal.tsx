          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            ...
            <div className="w-full">
              <textarea
                ...
                className="w-full h-20 px-4 py-3 rounded-lg border border-[#CACACA] bg-[#F0F0F0] text-sm sm:text-[15px] text-black placeholder:text-[#8E8E8E] focus:outline-none focus:ring-2 focus:ring-[#3CC27B] resize-none"
              />
            </div>
