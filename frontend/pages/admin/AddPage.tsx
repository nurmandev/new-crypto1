...
export const AddPage = () => {
  ...
  const handleAddPage = () => {
    ...
    // Navigate back to pages list after creation
    ...
    <div className="min-h-screen bg-[#F8F8F8] flex flex-col">
      ...
      <div className="flex flex-col flex-1 lg:ml-[259px]">
        ...
        <div className="flex-1 p-3 xs:p-4 sm:p-6 lg:p-8 overflow-y-auto">
          <div className="bg-white rounded-xl shadow-sm p-4 xs:p-6 sm:p-8 max-w-[1234px] mx-auto">
            {/* Header */}
            <div className="flex flex-col xs:flex-row items-start xs:items-center justify-between gap-4 mb-6">
              <div>
                <h1 className="text-lg xs:text-xl font-medium text-black mb-1 xs:mb-2">
                  Add New Page
                </h1>
                <p className="text-sm xs:text-base text-[#838383]">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xs:gap-6">
                <div>
                  <label className="block text-sm xs:text-base font-medium text-black mb-2 xs:mb-3">
                    Page Title
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-6 xs:px-10 py-3 xs:py-4 bg-[#F0F0F0] rounded-md text-xs xs:text-sm text-black placeholder:text-[#8E8E8E] outline-none focus:ring-2 focus:ring-[#3CC27B]"
                  />
                </div>
                <div>
                  <label className="block text-sm xs:text-base font-medium text-black mb-2 xs:mb-3">
              ...
              <div>
                ...
                <div className="border border-[#D3D3D3] rounded-md bg-[#FAFAFA] p-4 xs:p-6 sm:p-8 min-h-[300px] xs:min-h-[400px] sm:min-h-[576px]">
                  <textarea
                    ...
                    className="w-full h-full bg-transparent text-xs xs:text-sm sm:text-base text-black placeholder:text-[#8E8E8E] leading-relaxed xs:leading-loose outline-none resize-none"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xs:gap-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-6 xs:px-10 py-3 xs:py-4 bg-[#F0F0F0] rounded-md text-xs xs:text-sm text-black placeholder:text-[#8E8E8E] outline-none resize-none h-24 xs:h-32 lg:h-40 focus:ring-2 focus:ring-[#3CC27B]"
                  />
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full px-6 xs:px-10 py-3 xs:py-4 bg-[#F0F0F0] rounded-md text-xs xs:text-sm text-[#8E8E8E] outline-none appearance-none focus:ring-2 focus:ring-[#3CC27B]"
                    >
                    ...
                    <svg
                      className="absolute right-4 xs:right-6 top-1/2 -translate-y-1/2 pointer-events-none"
                      width="15"
                      height="11"
                      viewBox="0 0 15 11"
                      fill="none"
              ...
              <div className="flex justify-start pt-6">
                <button
                  ...
                  className="w-full sm:w-auto px-12 xs:px-16 lg:px-[60px] py-3 xs:py-4 bg-black text-white rounded-md border border-[#C3C3C3] text-sm xs:text-base font-medium hover:bg-gray-800 transition-colors"
                >
                  Add Page
                </button>
              </div>
