...
import { Bell, TrendingUp, Wallet, CreditCard, History, Shield, User, LogOut, Plus, DollarSign, ArrowUpRight, ArrowDownRight, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#F8F8F8] pb-12">
      ...
      <div className="bg-white rounded-[10px] mx-4 lg:mx-12 mt-6 px-6 py-4 flex items-center justify-between shadow-sm">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-xl lg:text-2xl font-bold text-gray-900">USDTMPAY</span>
        </Link>
      ...
      <div className="px-4 lg:px-12 mt-6 flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-64 bg-white rounded-lg overflow-hidden shadow-sm">
          ...
          <nav className="p-6 space-y-7">
            <Link to="/buy-crypto" className="flex items-center gap-3 text-black hover:text-[#3CC27B] transition-colors">
            ...
            <Link to="/" className="flex items-center gap-2 px-4 py-2 bg-[#EBEBEB] rounded text-black text-[15px] hover:bg-gray-300 transition-colors">
              <span>Logout</span>
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="bg-gradient-to-r from-[#3CC27B] to-[#00602D] rounded-[10px] p-6 lg:p-8 text-white shadow-lg">
            <div className="mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={() => setShowBalance(!showBalance)} className="text-gray-200 hover:text-white transition-colors">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-white font-medium text-center">Add Balance</span>
              </div>

              <div className="flex flex-col items-center gap-2">
                <div className="w-24 h-24 rounded-full border-[7px] border-[#3CC27B] bg-white flex items-center justify-center shadow-lg cursor-pointer hover:scale-105 transition-transform">
                  <DollarSign className="w-10 h-10 text-[#3CC27B]" strokeWidth={3} />
                </div>
                <span className="text-white font-medium text-center">Cashout</span>
              </div>

              <Link to="/buy-crypto" className="flex flex-col items-center gap-2">
                <div className="w-24 h-24 rounded-full border-[7px] border-[#3CC27B] bg-white flex items-center justify-center shadow-lg cursor-pointer hover:scale-105 transition-transform">
                  <TrendingUp className="w-10 h-10 text-[#3CC27B]" strokeWidth={2.5} />
                </div>
                <span className="text-white font-medium text-center">Buy</span>
              </Link>

              <Link to="/sell-crypto" className="flex flex-col items-center gap-2">
                <div className="w-24 h-24 rounded-full border-[7px] border-[#3CC27B] bg-white flex items-center justify-center shadow-lg cursor-pointer hover:scale-105 transition-transform">
                  <TrendingUp className="w-10 h-10 text-[#3CC27B] rotate-180" strokeWidth={2.5} />
                </div>
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="w-24 h-24 rounded-full border-[7px] border-[#3CC27B] bg-white flex items-center justify-center shadow-lg cursor-pointer hover:scale-105 transition-transform">
                  <Wallet className="w-10 h-10 text-[#3CC27B]" strokeWidth={2} />
                </div>
                <span className="text-white font-medium text-center">Wallet</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl font-medium text-black">Your Crypto Holdings</h2>
            ...
            <div className="space-y-3">
              {[1, 2, 3, 4, 5].map((item) => (
                <div key={item} className="flex items-center justify-between p-4 rounded-lg border border-[#D4D4D4] hover:border-[#3CC27B] transition-colors">
                  <div className="flex items-center gap-3">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl font-medium text-black">Live Price Markets</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="h-32 bg-gray-50 rounded-lg flex items-center justify-center border border-gray-200">
                  <svg className="w-full h-full p-4" viewBox="0 0 300 100" preserveAspectRatio="none">
                    <path d="M0,50 Q75,10 150,40 T300,30" fill="none" stroke="#FA1818" strokeWidth="2"/>
                  </svg>
                </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="h-32 bg-gray-50 rounded-lg flex items-center justify-center border border-gray-200">
                  <svg className="w-full h-full p-4" viewBox="0 0 300 100" preserveAspectRatio="none">
                    <path d="M0,80 Q75,60 150,70 T300,40" fill="none" stroke="#3CC27B" strokeWidth="2"/>
                  </svg>
                </div>
                <div className="flex justify-between text-xs text-gray-500">
                  <span>9:00</span>
          ...
          {/* More Coming Soon */}
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <h2 className="text-2xl font-medium text-black mb-6">More Coming Soon</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {[
                ...
                <div key={idx} className="flex flex-col items-center text-center">
                  ...
                  <p className="font-medium text-gray-400 mb-1">{service.name}</p>
        ...
        <div className="w-full lg:w-[360px] space-y-6">
          {/* Referral Status */}
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <h3 className="text-xl font-medium text-black mb-4">Referral Status</h3>
            
            <div className="flex items-center justify-center mb-6">
              <div className="relative w-40 h-40">
                <svg className="w-full h-full" viewBox="0 0 100 100">
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#EF4444" strokeWidth="20" strokeDasharray="75 251" transform="rotate(-90 50 50)"/>
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#F59E0B" strokeWidth="20" strokeDasharray="63 251" strokeDashoffset="-75" transform="rotate(-90 50 50)"/>
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#10B981" strokeWidth="20" strokeDasharray="113 251" strokeDashoffset="-138" transform="rotate(-90 50 50)"/>
                </svg>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-medium text-black">Invite Friends and Earn</h3>
            </div>

            <p className="text-xs text-gray-600 mb-4">Earn ₹500 Fix Bonus on Each referal</p>

            <div className="flex items-center justify-between p-4 bg-[#FAFAFA] rounded-lg border border-[#DBDBDB] mb-4">
              <div>
                <p className="text-sm font-medium text-black mb-1">Your Earnings</p>
            ...
            <h4 className="text-xl font-medium text-black mb-3">Recent Referrals</h4>

            <div className="space-y-2">
              {[
                { status: "Completed", color: "bg-[#BDFDDB]", textColor: "text-[#1C5C3A]" },
                { status: "Pending", color: "bg-[#FBD25F]/65", textColor: "text-black" },
                { status: "Completed", color: "bg-[#BDFDDB]", textColor: "text-[#1C5C3A]" },
                { status: "Completed", color: "bg-[#BDFDDB]", textColor: "text-[#1C5C3A]" }
              ].map((ref, idx) => (
                <div key={idx} className="flex items-center justify-between p-3 bg-[#F6F6F6] rounded-lg">
                  <div className="flex-1">
                    <p className="text-sm font-bold text-black">Sarah Smith</p>
                    <p className="text-xs text-gray-600">s***@email.com</p>
                  </div>
                  <div className={`px-3 py-1 ${ref.color} rounded text-xs ${ref.textColor} mr-2`}>
                    {ref.status}
                  </div>
                  <div className="text-right">
          ...
          <div className="bg-[#3CC27B]/10 rounded-lg p-6">
            <h4 className="text-xl font-medium text-black mb-3">How It Works:</h4>
            <ul className="space-y-2 text-sm text-black">
              <li className="leading-relaxed">• Your friend signs up using your link</li>
              <li className="leading-relaxed">• They get ₹150 signup bonus</li>
              <li className="leading-relaxed">• You earn ₹500 when they verify their account</li>
              <li className="leading-relaxed">• Bonuses are credited within 24 hours</li>
            </ul>
          </div>
        </div>
      </div>
