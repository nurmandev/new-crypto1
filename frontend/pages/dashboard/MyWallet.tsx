...
export default function MyWallet() {
  ...
  const cryptoHoldings = [
    { name: "Usdt", amount: "300 USDT", inrValue: "₹24,000.00", icon: "https://cryptologos.cc/logos/tether-usdt-logo.svg" },
    { name: "Bitcoin", amount: "0.05234 BTC", inrValue: "₹24,000.00", icon: "https://cryptologos.cc/logos/bitcoin-btc-logo.svg" },
    { name: "Ethereum", amount: "1.2345 ETH", inrValue: "₹24,000.00", icon: "https://cryptologos.cc/logos/ethereum-eth-logo.svg" },
    { name: "Usdt", amount: "300 USDT", inrValue: "₹24,000.00", icon: "https://cryptologos.cc/logos/tether-usdt-logo.svg" },
  ];

  const walletAddresses = [
    { label: "BTC Address", address: "bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh" },
    { label: "Ada Address", address: "bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh" },
    { label: "BTC Address", address: "addr1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh0fxy2kg" },
    { label: "ETH Address", address: "0x742d35Cc6635C0532925a3b8D22Ad5B73e9B6547" },
    { label: "BTC Address", address: "bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh" },
    { label: "BTC Address", address: "bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh" },
  ];

  const transactions = [
    { type: "Buy BTC", date: "2024-12-20 14:30", txId: "0x1234...5678", amount: "0.012 BTC", inr: "₹52,345" },
    { type: "Buy BTC", date: "2024-12-20 14:30", txId: "0x1234...5678", amount: "0.012 BTC", inr: "₹52,345" },
    { type: "Buy BTC", date: "2024-12-20 14:30", txId: "0x1234...5678", amount: "0.012 BTC", inr: "₹52,345" },
  ];
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="rounded-lg bg-gradient-to-r from-[#3CC27B] to-[#00602D] p-6 md:p-8 text-white">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div>
                <h2 className="text-lg md:text-xl font-medium mb-2">Wallet Balance</h2>
                <p className="text-4xl md:text-5xl font-bold">₹45,230.5</p>
              </div>
              <div>
                <h2 className="text-lg md:text-xl font-medium mb-2">Asset Value</h2>
            ...
            {/* Spending Limits */}
            <h3 className="text-lg md:text-xl font-medium mb-4">Daily and Monthly Spending Limits</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Daily Limit */}
              <div className="bg-white/10 rounded-lg p-4 md:p-6">
                <div className="flex justify-between items-center mb-2">
                  <span className="font-bold text-base md:text-lg">Daily Limit</span>
                  <span className="font-bold text-base md:text-lg">₹15,420 / ₹50,000</span>
                </div>
                <div className="w-full h-5 bg-white rounded-full mb-2">
                  <div className="h-4 bg-[#3CC27B] rounded-full mt-0.5 ml-0.5" style={{ width: '46%' }}></div>
                </div>
              ...
              <div className="bg-white/10 rounded-lg p-4 md:p-6">
                <div className="flex justify-between items-center mb-2">
                  <span className="font-bold text-base md:text-lg">Monthly Limit</span>
                  <span className="font-bold text-base md:text-lg">₹15,420 / ₹50,000</span>
                </div>
                <div className="w-full h-5 bg-white rounded-full mb-2">
                  <div className="h-4 bg-[#3CC27B] rounded-full mt-0.5 ml-0.5" style={{ width: '46%' }}></div>
          ...
          {/* Asset Allocation */}
          <div>
            <h2 className="text-xl md:text-2xl font-medium text-black mb-6">Asset Allocation</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
                ...
                <div key={index} className="flex flex-col items-center gap-3">
                  <div className="w-20 h-20 md:w-28 md:h-28 rounded-full border-[7px] border-[#3CC27B] bg-white shadow-lg flex items-center justify-center">
                    <span className="text-2xl md:text-3xl font-bold text-[#3CC27B]">
                      {asset.name === "INR" ? "₹" : asset.name === "BTC" ? "₿" : asset.name === "ETH" ? "Ξ" : asset.name === "ADA" ? "₳" : "₮"}
                    </span>
                  </div>
                  <p className="text-lg md:text-xl font-normal">{asset.name}</p>
                  <p className="text-lg md:text-xl font-semibold">{asset.percentage}</p>
                </div>
              ))}
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-lg md:text-xl font-bold text-[#3CC27B]">Add Crypto</p>
              </div>
            </div>
          </div>
          ...
          {/* My Holdings */}
          <div>
            <h2 className="text-xl md:text-2xl font-medium text-black mb-6">My Holdings</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {cryptoHoldings.map((holding, index) => (
                <div key={index} className="bg-white rounded-lg p-5 flex flex-col gap-2">
                  <div className="flex items-center gap-4">
                    <div>
                      <p className="text-sm text-black">{holding.name}</p>
                      <p className="text-base md:text-lg font-medium text-black">{holding.amount}</p>
                    </div>
                    <div className="w-7 h-7 rounded-full overflow-hidden flex-shrink-0">
                      <div className="w-full h-full bg-gray-200 rounded-full"></div>
                    </div>
                  </div>
                  <p className="text-sm md:text-base text-[#3CC27B] font-medium">₹ INR Value: {holding.inrValue}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Quick Actions */}
          <div>
            <h2 className="text-xl md:text-2xl font-medium text-black mb-6">Quick Actions</h2>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <Link to="/deposit-fund" className="bg-white rounded-lg p-6 flex flex-col items-center gap-4 hover:shadow-lg transition">
                <div className="w-11 h-11 rounded-full bg-[#3CC27B]/30 flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#3CC27B]" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M13 32H31V29.4118H13V32ZM31 17.7647H25.8571V10H18.1429V17.7647H13L22 26.8235L31 17.7647Z" />
                  </svg>
                </div>
                <p className="text-base md:text-lg font-medium text-center">Deposit Fund</p>
              </Link>

              <Link to="/withdraw-fund" className="bg-white rounded-lg p-6 flex flex-col items-center gap-4 hover:shadow-lg transition">
                <div className="w-11 h-11 rounded-full bg-[#3CC27B]/30 flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#3CC27B]" viewBox="0 0 24 24" fill="currentColor">
                ...
                <p className="text-base md:text-lg font-medium text-center">Withdraw Fund</p>
              </Link>

              <Link to="/deposit-crypto" className="bg-white rounded-lg p-6 flex flex-col items-center gap-4 hover:shadow-lg transition">
                <div className="w-11 h-11 rounded-full bg-[#3CC27B]/30 flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#3CC27B]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <p className="text-base md:text-lg font-medium text-center">Deposit Crypto</p>
              </Link>

              <Link to="/withdraw-crypto" className="bg-white rounded-lg p-6 flex flex-col items-center gap-4 hover:shadow-lg transition">
                <div className="w-11 h-11 rounded-full bg-[#3CC27B]/30 flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#3CC27B]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                <p className="text-base md:text-lg font-medium text-center">Withdraw Crypto</p>
              </Link>
            </div>
          </div>
          ...
          {/* Wallet Addresses */}
          <div>
            <h2 className="text-xl md:text-2xl font-medium text-black mb-6">Wallet Addresses</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {walletAddresses.map((wallet, index) => (
                <div key={index} className="rounded-lg border-[1.7px] border-dashed border-[#CACACA] bg-[#F0F0F0] p-6 flex items-center justify-between">
                  <div>
                    <p className="text-base md:text-lg font-medium text-black mb-2">{wallet.label}</p>
                    <p className="text-sm md:text-base text-[#8E8E8E] truncate max-w-[250px]">{wallet.address}</p>
                  </div>
                  <button
          ...
          {/* Recent Transactions */}
          <div>
            <h2 className="text-xl md:text-2xl font-medium text-black mb-6">Recent Transactions</h2>
            <div className="space-y-3">
              {transactions.map((tx, index) => (
                <div key={index} className="bg-white rounded-lg border border-[#D9D9D9] p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div className="flex-1">
                    <p className="text-base font-bold text-black mb-1">{tx.type}</p>
                    <p className="text-xs text-black mb-1">{tx.date}</p>
                    <p className="text-xs text-black">{tx.txId}</p>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="px-3 py-1 bg-[#BDFDDB] text-[#1C5C3A] text-xs rounded">Completed</span>
                    <div className="text-right">
                      <p className="text-base md:text-lg font-medium text-black">{tx.amount}</p>
